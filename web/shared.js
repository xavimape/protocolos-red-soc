...
// ── Cookie consent notice (tarjeta chica, no bloqueante) ─────
(function() {
  ...
  function showBanner() {
    ...
    // Entrada suave (evita el "salto" de aparecer de golpe)
  ...
  function init() {
    // Pequeña demora: no compite con el resto del contenido en el primer render
